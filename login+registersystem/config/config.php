...
define("DB_NAME", "2013_comp10120_b3");
define("DB_USER", "mbax2mf2");
define("DB_PASS", "Mohamed_1992");
 ...
 */
define("EMAIL_VERIFICATION_URL", $_SERVER['HTTP_HOST']."/php-login-advanced/register.php");
